...
export function AdminChecklistsPage() {
  ...
  return (
    <main className="page">
      <AdminHeader eyebrow="WORKFLOWS" title="Checklist reviews" description="Review submitted show checklists. Reusable checklist builders are now under Templates." />
